 ...
 * Generated: 2026-05-04T01:14:26.912Z
 */
  ...
  "src/utils/id_mapper.js"(exports2, module2) {
    ...
    function getTmdbInfo2(tmdbId, mediaType) {
      return __async(this, null, function* () {
        try {
          ...
          const url = `https://api.themoviedb.org/3/${type}/${tmdbId}?api_key=${TMDB_API_KEY2}&language=es-MX`;
    ...
    function getCorrectImdbId2(tmdbId, mediaType) {
      return __async(this, null, function* () {
        ...
        try {
          const type = mediaType === "movie" || mediaType === "movies" ? "movie" : "tv";
          const idUrl = `https://api.themoviedb.org/3/${type}/${tmdbId}/external_ids?api_key=${TMDB_API_KEY2}`;
    ...
    module2.exports = { getCorrectImdbId: getCorrectImdbId2, getTmdbInfo: getTmdbInfo2 };
  }
});
      ...
      if (jsonMatch) {
        try {
          ...
          if (data && data.source) {
            ...
            const validation = yield (0, import_m3u8.validateStream)({ url: data.source, headers: reqHeaders }, signal);
            return {
              url: data.source,
...
function resolveVidHide(url, signal = null) {
  return __async(this, null, function* () {
    try {
      ...
      const reqHeaders = __spreadProps(__spreadValues({}, (0, import_http.getStealthHeaders)()), { "Referer": url.split("?")[0], "Origin": new URL(url).origin, "User-Agent": currentUA });
  ...
  return __async(this, null, function* () {
    ...
    try {
      ...
      try {
        ...
        console.log(`[HackStore2-Filemoon] Shield Fallback: ${e.message}`);
      }
      return null;
    } catch (error) {
      return null;
  ...
  return __async(this, null, function* () {
    ...
    try {
      const [info, aliases] = yield Promise.all([
        (0, import_id_mapper.getTmdbInfo)(tmdbId, mediaType),
