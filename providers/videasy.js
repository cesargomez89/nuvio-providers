 ...
 * Generated: 2026-07-19T00:37:35.995Z
 */
...
var SERVERS = {
  ...
  Vimeos: {
    url: "https://api.videasy.net/vimeos/sources-with-title",
    label: "Vimeos",
    lang: "Latino"
  },
  Raze: {
...
function extractStreams(tmdbId, mediaType, season, episode, title) {
  return __async(this, null, function* () {
    try {
      ...
      return yield (0, import_engine.finalizeStreams)(flattened, "VidEasy Latino");
    } catch (e) {
      return [];
    }
  });
